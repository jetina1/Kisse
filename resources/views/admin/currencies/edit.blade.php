                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="money_format_thousands" type="text"
                                            name="money_format_thousands"
                                            value="{{ old('money_format_thousands', $currency->money_format_thousands) }}">
                                ...
                                <div class="col">
                                    <div class="form-group">
                                        ...
                                        <input class="form-control" id="money_format_decimal" type="text"
                                            name="money_format_decimal"
                                            value="{{ old('money_format_decimal', $currency->money_format_decimal) }}">
